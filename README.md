...
- **Español**: se usará español como idioma principal.
- **Cero IA**: se pueden usar herramientas de IA para buscar información, analizar texto, etc. pero no se debe escribir el contenido de las notas con IA. Con el código de la web se puede usar IA siempre y cuando este bien hecho.
